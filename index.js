...
/* As long as you are inside the parent function, any child functions can access variables that are defined within the parent function. The reverse isn't true however - variables within functions cannot be accessed outside of said functions. In other words, the nested function reached outside its scope to access a variable, which is closure. */
  ...
  */
  ...
  function animalNames(arr){
    ...
    arr.forEach(function(item){
      return newArr.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`);
    });
    return newArr;
  }
